...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex align-miscs-center p-3 mb-3 bg-{{ $colorTheme }} p-2 text-dark bg-opacity-25 rounded shadow-sm">
                <div class="me-auto">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->sub_total }}</td>
                                    <td class="text-end"><form method="POST" action="{{ route('misc.destroy', [ 'misc' => $row->id ]) }}">                        
